...
| 5 | **Confirm 0.7.0 actually publishes on the store** | next session | Uploaded and auto-submitted **2026-09-15 19:24:28 UTC** (Release run #25; `Publish successful` = *submitted*, not approved). **Read the listing**, never the inbox — 0.4.6, 0.5.0 and 0.6.0 all published with no email. 0.6.0 took ~54 minutes. Mark 0.7.0 **Live** in `RELEASES.md` only once the listing says 0.7.0. |
...
| | |
|---|---|
| **Latest version** | **0.7.0** — released on GitHub 2026-09-15 (tag `v0.7.0` @ `dabdfc1`, Release run #25), **uploaded and submitted to the store 19:24:28 UTC — NOT yet confirmed live** |
| **Live on the store** | **0.6.0** — confirmed 2026-09-15 19:04 UTC from the listing |
