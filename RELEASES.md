...
### 0.4.9 — released on GitHub (2026-09-08); submitted to the store (in review)
...
**Known limitation at ship time:** verified in tests (216 unit+integration, 17 system; 5 of 7 new
guards fail pre-fix) but **not on a live feed**. The decisive evidence is a fresh log export.
